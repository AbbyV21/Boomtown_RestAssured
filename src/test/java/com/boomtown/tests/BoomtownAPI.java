...
public class BoomtownAPI  {





    /**2. Use a query parameter of “query” with a search term such as “customer” or “test” to search (e.g. https://api.preprod.goboomtown.com/sdk/v1/kb/search?query=customer) 3. Use query parameters of “start” and “limit” to control paging where:
...
//        assertTrue(response.body().asString().contains("0, 1, 2"));
